...
<html dir='rtl'>
    ...
    <script>
	    ...
	    /*
	    function appdiv() {
	        document.getElementById('hon').value = "<div class='b'>\n<div class='m1'></div>\n<div class='m2'></div>\n</div>";
	        for(i=0;i<25;i++) {
	            document.getElementById('hon').value += "<div class='b'>\n<div class='m1'></div>\n<div class='m2'></div>\n</div>";
	        }
	    }*/
