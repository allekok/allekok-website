...
if(!empty($q1)) {
    ...
    if($r_max !== 0) {
	$r = 0;
	$r_max = !(filter_var($r_max, FILTER_VALIDATE_INT)===false) ? $r_max : 4;
    ...
    if($e_max !== 0) {
	$e = 0;
	$e_max = !(filter_var($e_max, FILTER_VALIDATE_INT)===false) ? $e_max : 4;
    ...
    if($h_max !== 0) {
	$h = 0;
	$h_max = !(filter_var($h_max, FILTER_VALIDATE_INT)===false) ? $h_max : 7;
