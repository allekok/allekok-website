...
function Liked() {
    ...
    if(favs != null) {
        ...
        if(where > -1) {
            ...
            ico.style.color = colors[JSON.parse(poemV2).poetID][1];
            ico.style.backgroundColor = colors[JSON.parse(poemV2).poetID][0];
            ico.style.animation = "";
            ...
            ico.style.color = colors[JSON.parse(poemV2).poetID][0];
